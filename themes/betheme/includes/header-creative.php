			...
			<div class="navi-header">
				<div class="wr-container">
					<div class="row">
						<div class="col-md-8">
							<ul>
								<li class="tie-ico-phone">+84.4 6257 6789</li>
								<li class="tie-ico-email">info@interland.vn</li>
								<li class="tie-ico-clock">8:00 - 17:30.</li>
							</ul>
						</div>
						<div class="col-md-4 text-right">
							<div class="lang-top">
								<a href="#">
									<img src="http://interland.vn/Content/Publishing/images/lang-vi.png" alt="">
								</a>
								<a href="#">
									<img src="http://interland.vn/Content/Publishing/images/lang-en.png" alt="">
								</a>
							</div>
						</div>
					</div>
